...
"""
Training script for DeepLabV3-ResNet101 on Cityscapes.

Design goals:
- Keep the overall structure similar to the provided U-Net / current DeepLab training script.
...
# -----------------------------
def get_args_parser():
    parser = ArgumentParser("Training script for a PyTorch DeepLabV3-ResNet101 model")
    ...
    parser.add_argument("--experiment-id", type=str, default="deeplabv3-resnet101-peak", help="Experiment ID for Weights & Biases")
    return parser
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
            ...
            print(f"valid_loss={valid_loss:.6f} | valid_mean_dice={valid_mean_dice:.6f}")
